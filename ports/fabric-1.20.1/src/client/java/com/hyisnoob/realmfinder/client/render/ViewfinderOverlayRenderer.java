...
public class ViewfinderOverlayRenderer {
    ...
    public static void register() {
        HudRenderCallback.EVENT.register(ViewfinderOverlayRenderer::renderOverlay);
    }
    ...
    private static void renderOverlay(GuiGraphics guiGraphics, float tickDelta) {
        ...
        float farVisualScale = Math.max(0.35f, Math.min(focusDistance / (focusDistance + 12.0f), 0.80f));
