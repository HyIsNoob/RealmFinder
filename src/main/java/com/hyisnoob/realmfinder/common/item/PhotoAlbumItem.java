...
public class PhotoAlbumItem extends Item {
    ...
    public static void loadInventory(ItemStack stack, Container container, HolderLookup.Provider registries) {
        ...
        if (tag.contains("AlbumItems", 10)) {
            ...
            ContainerHelper.loadAllItems(itemsTag, list, registries);
    ...
    public static void saveInventory(ItemStack stack, Container container, HolderLookup.Provider registries) {
        CompoundTag tag = PlatformHelper.getCustomTag(stack);
        ...
        ContainerHelper.saveAllItems(itemsTag, list, registries);
