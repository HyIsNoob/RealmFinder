...
public class ModItems {
    ...
    public static final Item CAMERA = new CameraItem(new Item.Properties().durability(100));
    public static final Item EMPTY_PHOTOGRAPH = new Item(new Item.Properties().stacksTo(64));
    ...
    public static void register() {
        ...
        Registry.register(BuiltInRegistries.ITEM, RealmFinder.id("empty_photograph"), EMPTY_PHOTOGRAPH);
